...
module GHC (
	...
	-- ** Source locations
	SrcLoc, pprDefnLoc,
        mkSrcLoc, {- XXX isGoodSrcLoc, -} noSrcLoc,
	srcLocFile, srcLocLine, srcLocCol,
        SrcSpan,
        mkSrcSpan, srcLocSpan, {- XXX isGoodSrcSpan, -} noSrcSpan,
...
showRichTokenStream = error "XXX"
{-
showRichTokenStream ts = go startLoc ts ""
    where sourceFile = error "XXX" -- XXX srcSpanFile (getLoc . fst . head $ ts)
