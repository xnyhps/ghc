...
canonicalize (CTyAppEqCan { cc_ev = ev, cc_tyvar = tv1, cc_tyargs = s1, cc_rhs = ty2, cc_loc = loc }) = do
  { traceTcS "canonicalize CTyAppEqCan" (ppr ev)
  ...
  ; traceTcS "canonicalize CTyAppEqCan" ((ppr (mkTcEqPred (mkAppTys xi1 xis3) xi2)) <+> (ppr (mkTcAppCo (mkTcAppCos co1 co3) co2)))
